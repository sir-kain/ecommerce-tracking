                ...
                (o = []),
                  (i = e(".sticky-header").each(function () {
                    var t = e(this),
                      ...
                      s = {};
                    i &&
                      (s = JSON.parse(i.replace(/'/g, '"').replace(";", ""))),
                      s.move &&
                        s.move.forEach(function (t) {
                          t.clone ||
                            ((t.indexStart = n), (n += e(t.item).length));
                        }),
    ...
    mMenuToggle: function () {
      e(".mobile-menu-toggler").on("click", function (t) {
        ...
        e(".menu-toggler").on("click", function (t) {
          e(window).width() >= 992
            ? e(".main-dropdown-menu").toggleClass("show")
            : e("body").toggleClass("mmenu-active"),
            t.preventDefault();
        }),
    ...
    sideMenu: function () {
      e(".side-menu").length &&
        e("body").on("click", ".side-menu-toggle", function (t) {
          e(this).siblings("ul").slideToggle("fast"),
